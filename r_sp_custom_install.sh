#!/bin/bash
# Script to install udunits2 2.2.20, gdal 3.2.2, geos 3.9.1, proj 7.2.1, SQLite, and curl 7.64.1
# Written by Ghanghoon "Will" Paik (gip5038@psu.edu)
# Sept 15 2021
# NOTE: Submit it as a job is recommended (takes long time to build)
# R packages (sp and gdalUtils) are added from r_spdep_dependency_install_user.sh
...
mv usr ~/work/spdep_dep
BUILD_DIR=~/work/spdep_dep
...
install.packages("spdep",lib = "$HOME/R/x86_64-pc-linux-gnu-library/4.1/", repos="http://cran.us.r-project.org")
install.packages("gdalUtils", configure.args = "--with-udunits2-lib=$BUILD_DIR/lib64 --with-udunits2-include=$BUILD_DIR/udunits2 udunits2=$BUILD_DIR/include", lib = "$HOME/R/x86_64-pc-linux-gnu-library/4.1/", repos="http://cran.us.r-project.org")
install.packages("sp", configure.args = "--with-udunits2-lib=$BUILD_DIR/lib64 --with-udunits2-include=$BUILD_DIR/udunits2 udunits2=$BUILD_DIR/include", lib = "$HOME/R/x86_64-pc-linux-gnu-library/4.1/", repos="http://cran.us.r-project.org")
q()
EOF
# Without --with-proj_api works
